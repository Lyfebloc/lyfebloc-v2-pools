...
export const exitExactLbptInForTokenOut = async (
  helpers: Contract,
  poolId: string,
  tokens: Token[],
  tokenOutSymbol: string,
  ...
  const userData = encode.exitUserData({
    ...
    llbptIn: utils.parseEther(llbptIn).toString(),
    tokenOutIndex,
  });
...
export const exitExactLbptInForTokensOut = async (
  helpers: Contract,
  poolId: string,
  tokens: Token[],
  llbptIn: string
...
export const exitLbptInForExactTokensOut = async (
  helpers: Contract,
  poolId: string,
  tokens: Token[],
  amountsOut: string[]
  ...
  const result = await exit(helpers, poolId, tokens, userData);
  return utils.formatEther(result.llbptIn).toString();
};
