...
export const _calcLbptInPerMainOut = (
  mainOut: BigNumber,
  mainBalance: BigNumber,
  wrappedBalance: BigNumber,
  bptSupply: BigNumber,
...
export const _calcMainOutPerLbptIn = (
  llbptIn: BigNumber,
  mainBalance: BigNumber,
  wrappedBalance: BigNumber,
  bptSupply: BigNumber,
  ...
  const previousNominalMain = _toNominal(mainBalance, params);
  const invariant = _calcInvariant(previousNominalMain, wrappedBalance);
  const deltaNominalMain = math.divDown(math.mul(invariant, llbptIn), bptSupply);
...
export const _calcLbptInPerWrappedOut = (
  wrappedOut: BigNumber,
  mainBalance: BigNumber,
  wrappedBalance: BigNumber,
  bptSupply: BigNumber,
...
export const _calcWrappedOutPerLbptIn = (
  llbptIn: BigNumber,
  mainBalance: BigNumber,
  wrappedBalance: BigNumber,
  bptSupply: BigNumber,
  ...
  const newBptBalance = fp.sub(bptSupply, llbptIn);
  const newWrappedBalance = fp.sub(
    math.divUp(math.mul(newBptBalance, previousInvariant), bptSupply),
    nominalMain
  );
...
export const _calcTokensOutGivenExactLbptIn = (
  ...
  **********************************************************************************************/
  ...
  for (let i = 0; i < balances.length; i++) {
    ...
    if (i !== llbptIndex) {
      amountsOut.push(fp.mulDown(balances[i], lbptRatio));
    } else {
