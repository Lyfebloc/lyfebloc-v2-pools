...
describe("StableMath", () => {
  ...
  describe("_calcLbptInGivenExactTokensOut", () => {
    ...
    afterEach(async () => {
      const evmExecution = evmStableMath._calcLbptInGivenExactTokensOut(
        toEvmBn(adjustAmp(amp)),
        scaleAll(balances, 18).map(toEvmBn),
      ...
      const sdkExecution = new Promise((resolve) =>
        resolve(
          sdkStableMath._calcLbptInGivenExactTokensOut(
            adjustAmp(amp),
            scaleAll(balances, 18),
  ...
  describe("_calcTokenOutGivenExactLbptIn", () => {
    ...
    afterEach(async () => {
      const evmExecution = evmStableMath._calcTokenOutGivenExactLbptIn(
        toEvmBn(adjustAmp(amp)),
        scaleAll(balances, 18).map(toEvmBn),
        tokenIndex,
      ...
      const sdkExecution = new Promise((resolve) =>
        resolve(
          sdkStableMath._calcTokenOutGivenExactLbptIn(
            adjustAmp(amp),
            scaleAll(balances, 18),
            tokenIndex,
  ...
  describe("_calcTokensOutGivenExactLbptIn", () => {
    ...
    afterEach(async () => {
      const evmExecution = evmStableMath._calcTokensOutGivenExactLbptIn(
        scaleAll(balances, 18).map(toEvmBn),
        toEvmBn(scale(lbptAmountIn, 18)),
        toEvmBn(scale(lbptTotalSupply, 18))
      );
      const sdkExecution = new Promise((resolve) =>
        resolve(
          sdkStableMath._calcTokensOutGivenExactLbptIn(
            scaleAll(balances, 18),
            scale(lbptAmountIn, 18),
            scale(lbptTotalSupply, 18)
          )
